...
* @see app/Http/Controllers/ReservationController.php:19
...
* @see app/Http/Controllers/ReservationController.php:92
...
* @see app/Http/Controllers/ReservationController.php:106
* @route '/admin/reservations'
*/
...
* @see app/Http/Controllers/ReservationController.php:122
...
* @see app/Http/Controllers/ReservationController.php:137
* @route '/admin/reservations/{reservation}'
*/
...
* @see app/Http/Controllers/ReservationController.php:149
* @route '/admin/reservations/{reservation}'
*/
