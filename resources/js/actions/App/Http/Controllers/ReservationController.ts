...
* @see app/Http/Controllers/ReservationController.php:20
...
* @see app/Http/Controllers/ReservationController.php:95
...
* @see app/Http/Controllers/ReservationController.php:109
* @route '/admin/reservations'
*/
...
* @see app/Http/Controllers/ReservationController.php:138
...
* @see app/Http/Controllers/ReservationController.php:153
* @route '/admin/reservations/{reservation}'
*/
...
* @see app/Http/Controllers/ReservationController.php:165
* @route '/admin/reservations/{reservation}'
*/
