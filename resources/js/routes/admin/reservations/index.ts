...
* @see app/Http/Controllers/ReservationController.php:61
...
* @see app/Http/Controllers/ReservationController.php:75
* @route '/admin/reservations'
*/
...
* @see app/Http/Controllers/ReservationController.php:91
...
* @see app/Http/Controllers/ReservationController.php:118
* @route '/admin/reservations/{reservation}'
*/
